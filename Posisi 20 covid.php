...
<head>
    ...
    <link rel="stylesheet" href="css/posisi20.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css">
    <script src="https://kit.fontawesome.com/a076d05399.js"></script>
    <title>Indonesia di Posisi 20 Kasus Positif Covid-19, Kamis 10 Desember 2020</title>
</head>
...
<body>
    ...
    <div id="kecil" class="container-md-fluid">
        <div class="col-md-8">
            <h1>Indonesia di Posisi 20 Kasus Positif Covid-19, Kamis 10 Desember 2020</h1>
            <h6 style="opacity: .5;">Date: 10 Desember 2020</h6>
            <img width="880px" src="img/datacov.png" alt="">
            <p>China berada di posisi ke-78 dengan jumlah kasus 86.661. Ada 4.634 pasien meninggal dunia, 81.743 pasien sembuh, dan ada 284 kasus aktif.</p>
            <br>
            <p>Sementara itu, Indonesia di posisi 20, diatas Cina, dengan jumlah kasus 592.900 kasus. Jumlah kematian 18.171 dan pasien dinyatakan sembuh 487.445 orang. Kini terdapat 87.284 kasus Covid-19 aktif atau yang dalam perawatan di Indonesia.</p>
            <br>
            <p>Bedasarakan lingkup Asia, Indonesia berada di atas China. Indonesia menadi negara dengan kasus Covid-19 terbanyak di Asia Tenggara. India menjadi negara Kawasan Asia dengan kasus Covid-19 terbanyak.</p>
            ...
            if ($_POST['Submit']) {
                ...
                #Get old comments
                $old = fopen("comments6.txt", "r+t");
                $old_comments = fread($old, 1024);
                #Delete everything, write down new and old comments
                $write = fopen("comments6.txt", "w+");
