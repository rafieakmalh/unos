...
<head>
    ...
    <title>NEGARA ASAL BENUA AMERIKA, MEKSIKO MEMBELI VAKSIN COVID-19 35 JUTA DOSIS DARI CHINA</title>
</head>
...
<body>
    ...
    <div id="kecil" class="container-md-fluid">
        <div class="col-md-8">
            <h1>NEGARA ASAL BENUA AMERIKA, MEKSIKO MEMBELI VAKSIN COVID-19 35 JUTA DOSIS DARI CHINA</h1>
            <h6 style="opacity: .5;">Date: 10 Desember 2020 19.41</h6>
            <img src="img/vaksin.jpg" alt="ilustrasi">
            <p>Kementerian Kesehatan Meksiko menandatangani kesepakatan pembelian 35 juta dosis vaksin Covid-19 buatan perusahaan farmasi asal China, CanSino Biologics. Ia juga mengatakan bahwa sebelum nya, Meksiko juga membeli vaksin Sputnik V berasal dari
                Rusia.
            </p>
            <br>
            <p>Presiden Meksiko Andreas Manuel Lopez, mengatakan siap menjadi relawan pertama yang di suntik vaksin Sputnik V. "Saya akan jadi yang pertama mendapatkan vaksin, karena itu amat penting bagi saya, namun kita harus...memastikan bahwa itu efektif
                dan tersedia bagi semuanya," kata Lopez Obrador dalam konferensi pers hariannya Agustus lalu.</p>
            <br>

            <br><br>
            <p>Sumber: https://www.cnnindonesia.com/internasional/20201210145907-134-580539/meksiko-beli-35-juta-dosis-vaksin-corona-buatan-china
            </p>
            ...
            if ($_POST['Submit']) {
                ...
                #Get old comments
                $old = fopen("comments8.txt", "r+t");
                $old_comments = fread($old, 1024);
                #Delete everything, write down new and old comments
                $write = fopen("comments8.txt", "w+");
