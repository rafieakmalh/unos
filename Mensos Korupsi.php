...
<head>
    ...
    <link rel="stylesheet" href="css/mensos.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css">
    <script src="https://kit.fontawesome.com/a076d05399.js"></script>
    <title>Mensos Tersangka Korupsi Dana Bansos</title>
</head>
...
<body>
    ...
    <div id="kecil" class="container-md-fluid">
        <div class="col-md-8">
            <h1>Mensos Tersangka Korupsi Dana Bansoss</h1>
            <h6 style="opacity: .5;">Date: 10 Desember 2020 20.00</h6>
            <img src="img/mensos.jpg" alt="">
            <p>Belakangan ini beredar kabar bahwa menteri sosial Indonesia yang bernama Juliari Peter Batubara di tetapkan sebagai tersangka korupsi program bantuan sosial penanganan Covid-19 oleh KPK pada hari minggu dini hari tanggal 06 – 12 – 2020. Sempat
                menjadi trending twitter indonesia dengan #mensos. Netizen memberikan komentar terhadap kasus korupsi tersebut. </p>
            <br>
            <p>Banyak warganet yang menilai tindakan tersebut adalah “menjijikan”, karena sekarang keadaan Indonesia sedang susah karena pandemi ini. Menteri Sosial diduga menerima uang sejumlah Rp 17 miliar dari 2 pelaksanaan paket bansos berupa sembako
                yang seharusnya digunakan untuk penanganan Covid-19. Juliari dijerat Pasal Pasal 12 huruf a atau Pasal 12 huruf b atau Pasal 11 UU nomor 31 Tahun 1999 sebagaimana telah diubah dengan UU nomor 20 Tahun 2001 tentang Pemberantasan Tindak
                Pidana Korupsi junctro asal 55 ayat (1) ke -1 KUHP.</p>
            <br>
            <p>Korupsi biasanya sudah dilakukan oleh manusia sejak kecil. Orang tua harus memberikan pendidikan berkarakter kepada anak - anaknya.</p>
            ...
            if ($_POST['Submit']) {
                ...
                #Get old comments
                $old = fopen("comments5.txt", "r+t");
                $old_comments = fread($old, 1024);
                #Delete everything, write down new and old comments
                $write = fopen("comments5.txt", "w+");
