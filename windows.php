...
<head>
    ...
    <title>Windows akan multifungsi di 2021</title>
</head>
...
<body>
    ...
    <div id="kecil" class="container-md-fluid">
        <div class="col-md-8">
            <h1>Windows akan multifungsi di 2021</h1>
            <h6 style="opacity: .5;">Date: 10 Desember 2020 20.00</h6>
            <img width="700px" height="600px" src="img/internasional.jpg" alt="">
            <p>Pada 2021 ada kabar bahwa Aplikasi Android bisa dipakai di windows 10 pada tahun 2021 mendatang. Kalau biasanya aplikasi Android dijalankan dengan emulator kalau yang ini berbeda. Nantinya, Microsoft Store akan menyediakan aplikasi Android.
                Jadinya, pengguna tidak perlu susah - susah untuk memasang software emulator seperti yang biasa digunakan yaitu nox, bluestack, dan lain sebagainya.</p>
            <br>
            ...
            if ($_POST['Submit']) {
                ...
                #Get old comments
                $old = fopen("comments9.txt", "r+t");
                $old_comments = fread($old, 1024);
                #Delete everything, write down new and old comments
                $write = fopen("comments9.txt", "w+");
